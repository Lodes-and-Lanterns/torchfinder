...
import { state, DATA_URL } from './scripts/state.js?v=3b3e6c26';
import { parseUrlParams } from './scripts/url.js?v=3b3e6c26';
import { applyFilters, sortFiltered, clearShuffleCache } from './scripts/filters.js?v=3b3e6c26';
import {
  showLoading,
  showError,
  enableControls,
  ...
  syncPillFade,
  closeAddToListModal,
} from './scripts/render.js?v=3b3e6c26';
import { getLists, importLists, clearAllLists } from './scripts/lists.js?v=3b3e6c26';
import { createMonthPicker } from './scripts/month-picker.js?v=3b3e6c26';
import { getCoverConsent, setCoverConsent } from './scripts/consent.js?v=3b3e6c26';
import {
  debouncedSearch,
  onSortChange,
  onClearFilters,
  ...
  closeListPanel,
  trapFocus,
} from './scripts/handlers.js?v=3b3e6c26';
...
async function init() {
  ...
  showLoading();
  state.data = [];
  const worker = new Worker('worker.js?v=3b3e6c26', { type: 'module' });
